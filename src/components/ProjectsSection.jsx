...
const projects = [
  {
    id: 1,
    title: "Weather App",
    description: "A responsive weather application that uses the OpenWeatherMap API to fetch and display current weather data and forecasts for various locations, built with React, styled-components, and modern UI design.",
  ...
  },
  {
    ...
    tags: ["Spotify Api","TailwindCSS", "ReactJs"],
    demoUrl: "#",
    githubUrl: "#",
  },
  {
    ...
    tags: ["Rapid Api", "Material-Ui", "ReactJs"],
    demoUrl: "#",
    githubUrl: "#",
  },
];
      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="text-center mt-12">
          <a
            ...
            target="_blank"
            href="https://github.com/Abhay-kashyap"
          >
